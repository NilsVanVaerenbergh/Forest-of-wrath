...
{
    internal class WelcomeTitle : IGameObject
    {

        private Animation animation;
        private Texture2D texture;
        private Vector2 position;
        private int frameWidth = 371;
        public WelcomeTitle() 
        {
            texture = Globals.contentManager.Load<Texture2D>("UI/main_screen");
            ...
            animation.AddFrame(new AnimationFrame(new Rectangle(frameWidth * 11, 0, frameWidth, texture.Height)));
