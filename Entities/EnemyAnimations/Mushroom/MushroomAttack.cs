...
namespace Forest_of_wrath.Entities.EnemyAnimations.Mushroom
{
    internal class MushroomAttack : IAnimationObject
    {
        private Animation animation;
        private Texture2D texture;
        public MushroomAttack()
        {
            animation = new Animation(8);
            texture = Globals.contentManager.Load<Texture2D>("Enemies/Toothwalker/Attack");
