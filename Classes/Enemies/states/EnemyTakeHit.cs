...
{
    internal class EnemyTakeHit : IEnemyStateObject
    {
        // Texture handeling:
        ...
        public EnemyTakeHit(ContentManager content, GraphicsDeviceManager graphicsDevice, Enemy enemyInstance, string locationPath, int frames, int[] hitBoxSize, float[] hitBoxOffset)
        {
